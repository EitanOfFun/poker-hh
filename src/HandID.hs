...
instance FromJSON HandID where
    parseJSON (Object v) = HandID <$> v .: "id" <*> v .: "label"
    parseJSON _          = mzero

parseHandIDs :: Value -> Parser [HandID]
parseHandIDs = withObject "HandIDs" $ \o -> o .: "data"

fixHandID :: HandID -> HandID
fixHandID (HandID h1 h2) = HandID {handID = h1, label = "_" ++ fmap replaceBadCharWith_ h2}
